...
type LimitPoolSettersConstructorArgs = Omit<ContractConstructorArgs, "signerOrProvider"> & { signerOrProvider: Signer };
...
export class LimitPoolSetters  {
    ...
    constructor(args:LimitPoolSettersConstructorArgs) {
        ...
        this.rangePool = LimitPool__factory.connect(args.poolAddress, args.signerOrProvider);
