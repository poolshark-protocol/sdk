...
interface CoverPoolModifiersInterface extends ethers.utils.Interface {
  functions: {
...
export class CoverPoolModifiers extends BaseContract {
  ...
  interface: CoverPoolModifiersInterface;
