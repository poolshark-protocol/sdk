...
export class CoverPoolModifiers__factory {
  static readonly abi = _abi;
  static createInterface(): CoverPoolModifiersInterface {
    return new utils.Interface(_abi) as CoverPoolModifiersInterface;
  }
  static connect(
    address: string,
