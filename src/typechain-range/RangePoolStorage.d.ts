...
interface RangePoolStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class RangePoolStorage extends BaseContract {
  ...
  interface: RangePoolStorageInterface;
