...
export class PoolsharkRangeSource extends BaseContract {
  ...
  functions: {
    ...
    rangePoolManager(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    rangePoolManager(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    rangePoolManager(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
